export default function Home() {
  ...
  return (
    <div className="bg-gray-100 text-green-700">
      <div>
        <span className="fixed left-0 text-5xl font-extrabold p-3 mx-3 animate-slidein"> {/* left side of navbar */}
          &lt;/&gt;
        </span>
        <span className="fixed right-0 text-right font-bold p-3 animate-slidein"> {/* right side of navbar */}
      ...
      <div className="h-screen flex justify-center items-center text-7xl">
        <span className="animate-slidein flex-col text-center">
